...
namespace MiscUtil.Reflection
{
    ...
    {
        public static string[] ExcludeProps { get; set; }
        /// <summary>
        ...
        public static void Copy<TSource, TTarget>(TSource source, TTarget target, string[] excludeProps = null)
            where TSource : class
            where TTarget : class
        {
    ...
    internal static class PropertyCopier<TSource, TTarget>
    {
        ...
        internal static TTarget Copy(TSource source, string[] excludeProps = null)
        {
        ...
        private static Func<TSource, TTarget> BuildCreator()
        {
            ...
            foreach (PropertyInfo sourceProperty in typeof(TSource).GetProperties(BindingFlags.Public | BindingFlags.Instance))
            {
                ...
                if (PropertyCopy.ExcludeProps != null && PropertyCopy.ExcludeProps.Contains(sourceProperty.Name))
                {
                    continue;
                }
